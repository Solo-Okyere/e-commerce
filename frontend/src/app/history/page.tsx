      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="mb-6 rounded-3xl bg-white p-6 shadow-sm">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-2 text-gray-600">View your previously delivered orders.</p>
            </div>
          </div>
        </div>
        ...
        {loading && orders.length === 0 ? (
          ...
          <div className="rounded-3xl bg-white p-8 shadow-sm text-center text-gray-600">
            <p className="text-lg">No previous orders yet.</p>
          </div>
        ) : (
          <div className="space-y-6">
            {orders.map((order) => {
              const activeStep = 4; // Delivered orders are always at step 4
              return (
